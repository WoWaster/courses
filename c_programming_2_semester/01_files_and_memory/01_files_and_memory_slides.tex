...
\subject{Структуры, указатели, модули и файлы. Общие правила разбиения на модули, модули в C. Понятие процесса. Ввод-вывод stdio.h. Файловый ввод-вывод: буферизованный, файлы, отображаемые на память. Работа с динамической памятью. Виртуальная память. Системные вызовы.}
