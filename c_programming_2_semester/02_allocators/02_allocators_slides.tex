...
\subject{Понятие процесса. Ввод-вывод stdio.h. Файловый ввод-вывод: буферизованный, файлы, отображаемые на память. Работа с динамической памятью. Виртуальная память. Внутреннее устройство аллокаторов динамической памяти.  Системные вызов}
