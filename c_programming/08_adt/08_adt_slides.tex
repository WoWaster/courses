...
% https://github.com/yurii-litvinov/courses/tree/master/programming-1st-semester/13-abstract-data-types
...
\begin{frame}
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.4\textwidth}
            \begin{center}
                \includegraphics[width=0.75\textwidth]{mergesort.png}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
