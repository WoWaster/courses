...
% \begin{frame}
%     \frametitle{Указатели I/II}

%     \begin{center}
%         \includegraphics[height=6cm]{pointers.pdf}
%     \end{center}
%     {\scriptsize \copyright{} Original: Daniel B Vector: Ufo karadagli (https://commons.wikimedia.org/wiki/File:Zeiger.svg), „Zeiger“, https://creativecommons.org/licenses/by-sa/3.0/legalcode }
% \end{frame}
...
% \begin{frame}
%     \frametitle{Статические массивы}

%     \inputminted{c}{01_arrays.c}
% \end{frame}

% \begin{frame}
%     \frametitle{Динамические массивы}

%     \inputminted[fontsize=\small]{c}{01_malloc.c}
